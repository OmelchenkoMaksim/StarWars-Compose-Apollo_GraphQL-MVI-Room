...
internal object GreenColors {
    ...
    val springGreenLight = Color(0xFF00FF9D)
    val paleGreenLight = Color(0xFFB2FFB2)
    val mediumSeaGreen = Color(0xFF3CB371)
    val lightGreen = Color(0xFF90EE90)
    val mediumSpringGreen = Color(0xFF00FA9A)
    val lightMint = Color(0xFFAFFFDF)
    val lightLimeGreen = Color(0xFF7FFF00)
...
internal object PurpleColors {
    ...
    val lightOrchid = Color(0xFFDA70D6)
    val mediumOrchid = Color(0xFFBA55D3)
    val lightViolet = Color(0xFFD8BFD8)
    val paleLavender = Color(0xFFDCC6E0)
...
internal object OrangeColors {
    ...
    val lightGold = Color(0xFFFFFACD)
    val lightPeach = Color(0xFFFFEFD5)
    val sunset = Color(0xFFFFCC99)
    val melon = Color(0xFFE3A869)
}
